...
import { FaReact, FaVuejs, FaWhatsapp } from "react-icons/fa";
...
<main className="container mx-auto p-6 lg:p-16"> {/* About me */}
  ...
  <a href="https://wa.me/5217221828896" target="_blank" className="fixed bottom-10 right-4 bg-green-500 text-white p-3 rounded-full shadow-lg hover:bg-green-600"><FaWhatsapp size={24} title="Contactame"/></a>
...
{/* Proyecto 3 */}
  <div class="relative max-w-sm rounded-lg overflow-hidden bg-white text-orange-600 shadow-md shadow-yellow-500 hover:shadow-xl transform transition duration-300 hover:scale-105">
    ...
    <div class="px-6 py-4">
      ...
      <p class="text-yellow-600 font-semibold text-base mb-4">
        {texts[language].descPro3}
      </p>
      
      <div class="flex flex-wrap gap-2 mt-4 mb-16 justify-center style-icon-cardGold">
        <FaReact size={18} title="React"/>
        <SiTailwindcss size={18} title="Tailwind CSS"/>
      </div>
    </div>
    
    <a href="https://jcesar206.github.io/notesFront/" target="_blank" class="absolute bottom-2 left-1/2 -translate-x-1/2 w-[90%] flex justify-center">
      <button class="style-btn-gotopageGold">
        {texts[language].goToPage}
      </button>
    </a>
  </div>
