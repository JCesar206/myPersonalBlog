...
export default function Footer({ language = "es" }) {
	...
	<footer className="w-full px-4 py-6">
	  <div className="w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-md rounded-full">
        ...
        <a href="mailto:jcesar206@hotmail.com" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 transition">
          <FaEnvelope size={20}/>
        </a>
				<a href="mailto:jcesary06@gmail.com" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 transition">
          <SiGmail size={20}/>
        </a>
			</div>
			{/*Copyright*/}
