...
export default function CurrentJob ({ language = "es" }) {
	...
	return (
		<div className="flex items-center space-x-4 p-6 bg-gray-200/50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-500 dark:bg-gray-900">
			...
			<div className="justify-center items-center gap-2 space-y-2 space-x-2">
				...
				<a href="https://www.asteroi.dev/" target="_blank" rel="noopener noreferrer">
				<p className="text-gray-700 font-bold text-center hover:underline">Asteroi.dev</p>
				</a>
			</div>
		</div>
	);
